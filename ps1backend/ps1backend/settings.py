"""
Django settings for ps1backend project.
...
SECRET_KEY = 'django-insecure-+7p-+z(pacws3oa)nm9g!sb4r=8=ya#3nk-$6*!-hr-hi)4@ju'
...
WSGI_APPLICATION = 'ps1backend.wsgi.application'
